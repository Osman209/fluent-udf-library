...
| damping_zone_source.c | DEFINE_SOURCE | Cell Zone > Source Terms > momentum (mixture) |
...
- Inlet: velocity inlet on the whole left wall (air and water), with the
  three profiles hooked. Top: pressure outlet. Right: pressure outlet
  with the damping zone in front of it.
